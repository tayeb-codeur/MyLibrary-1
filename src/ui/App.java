        ...
        while (choixMenu != 0) {
            ...
            switch (choixMenu) {
                ...
                case 3:
                    ...
                    System.out.println("Le livre " + myLibrary.getBooks().get(idBook).getTitle() + " doit être retourné pour le " + myLibrary.getBooks().get(idBook).getBorrowingDate().plusDays(myLibrary.getBooks().get(idBook).getLoanPeriod()).toString());
